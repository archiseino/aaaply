/**
 * Outlook API Email Sender (Microsoft Graph)
 * 
 * Sends an Outlook email with CV attachment directly from the browser.
 * Uses MSAL.js (Microsoft Authentication Library) for OAuth 2.0.
 * No backend required. Works on deployed web & mobile.
 * 
 * Cost: ZERO. Uses Microsoft's free Graph API.
 */
